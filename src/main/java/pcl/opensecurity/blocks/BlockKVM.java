...
public class BlockKVM extends BlockOSBase {
    ...
    public IIcon getIcon(IBlockAccess block, int x, int y, int z, int side) {
        ...
        if (KVMTE.down && side == 0) return this.outputCon;
        else if (KVMTE.up && side == 1) return this.outputCon;
        else if (KVMTE.north && side == 2) return this.outputCon;
        else if (KVMTE.south && side == 3) return this.outputCon;
        else if (KVMTE.west && side == 4) return this.outputCon;
        else if (KVMTE.east && side == 5) return this.outputCon;
