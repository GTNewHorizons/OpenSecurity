...
public class BlockSwitchableHub extends BlockOSBase {
    ...
    public IIcon getIcon(IBlockAccess block, int x, int y, int z, int side) {
        ...
        if (metadata == 0 && side == 0) return this.inputCon;
        else if (metadata == 1 && side == 1) return this.inputCon;
        else if (metadata == 2 && side == 2) return this.inputCon;
        else if (metadata == 3 && side == 3) return this.inputCon;
        else if (metadata == 4 && side == 4) return this.inputCon;
        else if (metadata == 5 && side == 5) return this.inputCon;

        if (switchTE.down && side == 0) return this.outputCon;
        else if (switchTE.up && side == 1) return this.outputCon;
        else if (switchTE.north && side == 2) return this.outputCon;
        else if (switchTE.south && side == 3) return this.outputCon;
        else if (switchTE.west && side == 4) return this.outputCon;
        else if (switchTE.east && side == 5) return this.outputCon;
