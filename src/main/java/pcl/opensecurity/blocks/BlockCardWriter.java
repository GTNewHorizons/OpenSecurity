...
public class BlockCardWriter extends BlockOSBase {
    ...
    public IIcon getIcon(int side, int metadata) {
        ...
        if (metadata == 1 && side == 1) return this.faceIcon;
        else if (metadata == 0 && side == 0) return this.faceIcon;
        else if (metadata == 2 && side == 2) return this.faceIcon;
        else if (metadata == 3 && side == 3) return this.faceIcon;
        else if (metadata == 4 && side == 4) return this.faceIcon;
        else if (metadata == 5 && side == 5) return this.faceIcon;
