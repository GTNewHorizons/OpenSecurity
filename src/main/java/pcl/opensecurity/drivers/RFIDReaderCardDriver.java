...
public class RFIDReaderCardDriver extends DriverItem {
    ...
    public ManagedEnvironment createEnvironment(ItemStack arg0, li.cil.oc.api.network.EnvironmentHost arg1) {
        if (arg1 instanceof TileEntity) return new Environment(arg1);
        if (arg1 instanceof TabletWrapper) return new Environment(arg1);
        return null;
    }
                        ...
                        for (int k = 0; k < size; k++) {
                            ...
                            if (st != null
                                ...
                                output.put(
                                        ...
                                        info(
                                                entity,
                                                st.stackTagCompound.getString("data"),
                                                localUUID,
                                                st.stackTagCompound.getBoolean("locked")));
                            }
                        }
