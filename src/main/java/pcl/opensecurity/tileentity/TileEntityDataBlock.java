...
public class TileEntityDataBlock extends TileEntityMachineBase implements Environment {
    ...
    private void initOCFilesystem() {
        oc_fs = li.cil.oc.api.FileSystem.asManagedEnvironment(
                li.cil.oc.api.FileSystem.fromClass(OpenSecurity.class, OpenSecurity.MODID, "/lua/datablock/"),
                "datablock");
    ...
    @Callback(
            direct = true,
            limit = 6,
            doc = "function(data:string):string -- Applies deflate compression to the data.")
    ...
    @Callback(
            direct = true,
            limit = 6,
            doc = "function(data:string):string -- Applies inflate decompression to the data.")
