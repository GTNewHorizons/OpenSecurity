...
public class RenderKeypad extends TileEntitySpecialRenderer implements IItemRenderer {
    ...
    static {
        ...
        for (int i = 0; i < 12; ++i) itemButtonStates[i] = new ButtonState();
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        // float light = tileEntity.getWorldObj().getLightBrightnessForSkyBlocks(tileEntity.xCoord, tileEntity.yCoord,
    ...
    public void drawKeypadBlock(TileEntityKeypadLock keylock, long time) {
        ...
        for (int i = 0; i < 12; ++i) renderButtonGeometry(tessellator, pressed[i] ? texPixel * .75f : 0f, buttons[i]);
        ...
        if (font != null) {
            ...
            if (fbText != null && fbText.length() > 0) writeButtonLabel(font, 0f, display, fbColor, fbText);
        }
    }
