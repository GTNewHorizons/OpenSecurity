 ...
 * Source: https://github.com/McJty/McJtyLib/blob/master/src/main/java/mcjty/varia/WrenchChecker.java Original:
 * https://github.com/McJty/RFTools/issues/13
 */
public class WrenchChecker {
    ...
    public static void init() {
        for (String className : new String[] {
                /*
                 * Can add or remove class names here Use API interface names where possible, in case of refactoring
                 * note that many mods implement BC wrench API iff BC is installed and include no wrench API of their
                 * own - we use implementation classes here to catch these cases.
                 */
                ...
                "pneumaticCraft.common.item.ItemPneumaticWrench", "li.cil.oc.common.item.Wrench", // OC Scrench
